...
#
# Modified from *2008 Brett Slatkin*
...
class HomeHandler(BaseHandler):
  def get(self):
    ...
    if form_url:
      ...
      if inputted_url.startswith(HTTPS_PREFIX):
    ...
    if self.request.scheme == "http":
      secure_url = "https://kxprxy.appspot.com"
    context = {
...
class MainHandler(BaseHandler):
  def get(self):
    ...
    self.response.out.write(template.render("main/about.html", context))
